...
export default function Home() {
  ...
  const featuredEvent =
    [...upcomingEvents].sort((a, b) => new Date(a.date) - new Date(b.date))[0] || null;
      ...
      <div className="grid md:grid-cols-2 gap-10 items-stretch mb-12 sm:mb-16">
        <div>
          ...
          <h1 className="text-4xl sm:text-6xl font-bold leading-tight text-gray-900">
            Discover <span className="text-purple-700">Events</span>
          </h1>
        ...
        <div
          ...
          className="relative overflow-hidden rounded-[32px] p-8 min-h-[320px] bg-gradient-to-br from-indigo-600 via-violet-600 to-purple-700 shadow-[0_20px_60px_rgba(79,70,229,0.35)] border border-white/20 cursor-pointer flex flex-col"
        >
          <div className="relative z-10 flex flex-col h-full">
            ...
            <p className="text-indigo-100 mb-8 line-clamp-3">
              {featuredEvent?.description || "Create your first event and start exploring!"}
            </p>
        ...
        <>
          ...
          <div className="flex justify-center mt-12">
            <button
              ...
              className="btn rounded-full bg-gradient-to-r from-indigo-500 via-violet-500 to-purple-600 text-white hover:scale-105 transition"
            >
              Explore All Events
            </button>
          </div>
